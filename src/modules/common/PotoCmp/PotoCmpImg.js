...
module.exports = React.createClass({
    ...
    render: function() {
        ...
        return (
            <div style={{padding: '0 10px',width:'100%',overflow:'hidden'}}>
                {
                    _data.imgs&&_data.imgs.length>0?_data.imgs.map(function (_img,_index) {
                            return(
                                <div style={style.tabs_img}>
                                    <Image style={{width:51,height:51,lineHeight:'51px'}} imgSrc={_img+'-small'} onClick={this.seeBigPoto.bind(this,_data.imgs,_index)}/>
                                    <Icon style={style.tabs_img_icon} type="cross-circle" onClick={this.removePotp.bind(this,_index)} />
                                </div>
                            )
                        }.bind(this)):''
                }
